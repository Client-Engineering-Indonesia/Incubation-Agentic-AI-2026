...
Ensure you have created a PostgreSQL connection in watsonx Orchestrate (from Module 2.1):

1. Log in to **watsonx Orchestrate**
2. Go to **Connections** dashboard
3. Verify your PostgreSQL connection exists (e.g., `postgres_connection`)
4. Note the connection name - you'll use it when importing the tool
...
![Verify Connection](images/2.3-02-verify-connection.png)

---

### Step 3: Create Database Query Function

The Python function will use the connection you created in Module 2.1. When deployed to watsonx Orchestrate, it will automatically use the configured connection credentials.
